 ...
 * notes into another's — the 2026-08-15 incident CLAUDE.md's "One deliberate, scoped exception"
 * note records. A read that falls back gives a bad answer; a write that falls back writes to the
 * wrong place, so only writers call this.
 *
