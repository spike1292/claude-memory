...
2026-09-05 — an agent working in this repo wrote a lesson to a cloud-synced folder outside the
vault entirely, a location that has nothing to do with this plugin or with the vault. The user
caught it and pointed out the vault lives somewhere else.
...
```
"CLAUDE_COWORK_MEMORY_PATH_OVERRIDE": "/Users/<name>/SomeCloudDrive/Work/AI"
```
